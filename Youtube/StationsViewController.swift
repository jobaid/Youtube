...
class StationsViewController: UIViewController ,GADNativeExpressAdViewDelegate,GADInterstitialDelegate{
    ...
    override func viewDidLoad() {
        ...
        Timer.scheduledTimer(timeInterval: TimeInterval(10), target: self, selector: #selector(StationsViewController.loadad), userInfo: nil, repeats: false)
    ...
    // Bangla TV এর জায়গাই নতুন app নাম দিবেন
    ...
    func loadStationsFromJSON() {
        ...
        DataManager.getStationDataWithSuccess() { (data) in
            ...
            if let stationArray = json["items"].array {
